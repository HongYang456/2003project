...
public class RecSpecialAdapter extends RecyclerView.Adapter {
    Context context;
    ArrayList<HomeBean.DataDTO.TopicListDTO> listBeans;

    public RecSpecialAdapter(Context context, ArrayList<HomeBean.DataDTO.TopicListDTO> listBeans) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        HomeBean.DataDTO.TopicListDTO topicListBean = listBeans.get(position);
